...
func TestValidateAlreadyExists(t *testing.T) {
	...
	servertest.Mux.HandleFunc("/validators/services/id",
		func(w http.ResponseWriter, r *http.Request) {
			...
			w.WriteHeader(404)
			_, _ = fmt.Fprint(w, tdata.FromFile("mocks/service_already_exists_response.json"))
		})
...
func TestValidateInvalidID(t *testing.T) {
	...
	servertest.Mux.HandleFunc("/validators/services/id",
		func(w http.ResponseWriter, r *http.Request) {
			w.Header().Set("Content-Type", "application/json; charset=UTF-8")
			w.WriteHeader(404)
			_, _ = fmt.Fprint(w, tdata.FromFile("mocks/service_invalid_id_response.json"))
		})
...
func TestValidateError(t *testing.T) {
	...
	servertest.Mux.HandleFunc("/validators/services/id",
		func(w http.ResponseWriter, r *http.Request) {
			w.Header().Set("Content-Type", "application/json; charset=UTF-8")
			w.WriteHeader(400)
			_, _ = fmt.Fprint(w, tdata.FromFile("../apihelper/mocks/unknown_error_api_response.json"))
		})
