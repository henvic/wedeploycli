...
var (
	// Version of the Liferay Cloud Platform CLI tool
	Version = "master"
	...
	// CloudRemote is the name for the default cloud for Liferay Cloud
	CloudRemote = "lcp"
...
If you want to learn how to use the CLI for Liferay Cloud, please see:
