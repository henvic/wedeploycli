...
func TestMain(m *testing.M) {
	...
	var err error
	conf, err = config.Setup("mocks/.liferaycli")
...
func TestAuth(t *testing.T) {
	r := wedeploy.URL("https://api.us-west-1.liferay.cloud/")
...
func TestRequestVerboseFeedback(t *testing.T) {
	...
	var find = []string{
		"> GET https://api.us-west-1.liferay.cloud/foo HTTP/1.1",
...
func TestRequestVerboseFeedbackJSONResponse(t *testing.T) {
	...
	var find = []string{
		"> POST https://api.us-west-1.liferay.cloud/foo HTTP/1.1",
		`{"bar":"one"}`,
		"{\n    \"Hello\": \"World\"\n}",
	}
...
func TestRequestVerboseFeedbackNotComplete(t *testing.T) {
	...
	stringlib.AssertSimilar(t,
		"> (wait) https://api.us-west-1.liferay.cloud/foo",
		bufErrStream.String())
...
func TestURL(t *testing.T) {
	...
	var want = "https://api.us-west-1.liferay.cloud/x/y/z/k"
...
func TestValidateUnexpectedResponseNonBody(t *testing.T) {
	...
	var want = `403 Forbidden (GET https://api.us-west-1.liferay.cloud/foo/bah): Response Body is not JSON`
