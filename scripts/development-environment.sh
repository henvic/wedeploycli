...
# Install environment for development on the Liferay CLI Tool
...
function welcome() {
  echo "Liferay Command-Line-Interface Development Environment installer."
...
function infoRenewShell() {
  ...
  echo "For example: instead of using \"liferay list\" to list your services, use \"i list\" like this:"
  echo
  echo "$ i list --help"
